...
then
	...
	do
		...
		then
			...
			rsync -av --progress --modify-window=8000 --delete "/home/vegard/Musikk/$f" .
		fi
	done
else
	...
	rsync -av --progress --modify-window=8000 --delete \
	...
	rsync -avz --progress --modify-window=8000 "/home/vegard/Musikk/unsorted" "/media/Vegards Pod"
